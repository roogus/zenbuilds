...
SRC_URI="https://github.com/ROCm-Developer-Tools/roctracer/archive/refs/tags/rocm-${MY_PV}.tar.gz -> rocm-tracer-${MY_PV}.tar.gz
		https://github.com/ROCm-Developer-Tools/rocprofiler/archive/refs/tags/rocm-${MY_PV}.tar.gz -> rocprofiler-${MY_PV}.tar.gz"
...
S="${WORKDIR}/roctracer-rocm-${MY_PV}"

src_prepare() {
	mv "${WORKDIR}"/rocprofiler-rocm-${MY_PV} "${WORKDIR}"/rocprofiler || die
