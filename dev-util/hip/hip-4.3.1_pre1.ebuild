...
SRC_URI="https://github.com/ROCm-Developer-Tools/HIP/archive/refs/tags/rocm-${MY_PV}.tar.gz -> rocm-hip-${MY_PV}.tar.gz
...
src_prepare() {
	...
	cp -a "${WORKDIR}"/ROCm-OpenCL-Runtime-rocm-${MY_PV}/amdocl/cl_vk_amd.hpp amdocl/ || die

	# Force the use of the system OpenCL headers, except for the AMD extensions in `CL/cl_ext.h`
