...
SRC_URI="https://github.com/RadeonOpenCompute/llvm-project/archive/refs/tags/rocm-${MY_PV}.tar.gz -> llvm-rocm-ocl-${MY_PV}.tar.gz"
...
S="${WORKDIR}/llvm-project-rocm-${MY_PV}/llvm"
...
src_prepare() {
	cd "${WORKDIR}/llvm-project-rocm-${MY_PV}" || die
