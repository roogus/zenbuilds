...
if [[ ${PV} == *9999 ]] ; then
	...
	SRC_URI="https://github.com/RadeonOpenCompute/ROCm-CompilerSupport/archive/refs/tags/rocm-${MY_PV}.tar.gz -> ${PN}-${MY_PV}.tar.gz"
	S="${WORKDIR}/ROCm-CompilerSupport-rocm-${MY_PV}/lib/comgr"
	KEYWORDS="~amd64"
fi
