...
SRC_URI="https://github.com/ROCmSoftwarePlatform/MIOpen/archive/refs/tags/${MY_PV}.tar.gz -> MIOpen-${PV}.tar.gz"

LICENSE="MIT"
KEYWORDS="~amd64"
SLOT="0"

IUSE="+miopengemm -opencl -static-boost"

RDEPEND="
	>=dev-util/hip-${PV}
	>=dev-libs/half-1.12.0
	dev-libs/opencl-icd-loader
	miopengemm? ( >=sci-libs/miopengemm-${PV} )
	opencl? (
		sys-devel/llvm-roc
...
src_configure() {
	...
	if use opencl; then
		...
		if use miopengemm; then
			mycmakeargs+=( "-DMIOPEN_USE_MIOPENGEMM=On" )
		fi
	fi
